...
;|*2*|For Subtraction, set codeDriver to 1.
;|*3*|For Product, set codeDriver to 2.
;|*4*|For Division, set codeDriver to 3.
;|*5*|For Modulus, set codeDriver to 4.
;|*6*|For Power, set codeDriver to 5
;|*7*|For Average of numbers, set codeDriver to 6.
;|*8*|For Percentage out of 100, set codeDriver to 7.
codeDriver: dw 7
;|***|"num1" and "num2" are the numbers which you will use.
;|***|Go ahead and assign values to the following variables.

num1: dw 2  ;
num2: dw 2  ;For division use num2 as devisor. For Power use num2. For obtain marks use num2.
...
start:
    ...
    xor si,si
        ...
        jne     subFragment
        call    sum   ;Write the function you want to do.
        mov     [total], ax
        jmp     end
subFragment:
